...
namespace Funly.SkyStudio
{
  ...
  public class SkyMaterialController : System.Object
  {
    ...
    [SerializeField, Range(0.0f, 1.0f)]
    private float _moonAlpha = 1.0f;
    public float MoonAlpha
    {
      get { return _moonAlpha; }
      set {
        _moonAlpha = value;
        SkyboxMaterial.SetFloat("_MoonAlpha", _moonAlpha);
      }
    }
    ...
    [SerializeField, Range(0.0f, 1.0f)]
    private float _sunAlpha = 1.0f;
    public float SunAlpha
    {
      get { return _sunAlpha; }
      set {
        _sunAlpha = value;
        SkyboxMaterial.SetFloat("_SunAlpha", _sunAlpha);
      }
    }
    ...
    [SerializeField]
    private float _cloudAlpha = 1;
    public float CloudAlpha
    {
      get { return _cloudAlpha; }
      set {
        _cloudAlpha = value;
        SkyboxMaterial.SetFloat("_CloudAlpha", _cloudAlpha);
      }
    }
