    ...
    protected override ProfileFeatureSection[] ProfileFeatureSection()
    {
      return new[]
      {
        ...
        new ProfileFeatureSection("Sky", ProfileSectionKeys.SkySectionKey, new[] {
          ...
          ProfileFeatureDefinition.CreateBooleanFeature(ProfileFeatureKeys.AmbientLightGradient, false, "Ambient Light Gradient", null, false,
            "If enabled updates the ambient light colors in located in Lighting -> Environment Lighting. It's useful to adjust ambient lighting in day/night cycles for a more immersive effect.")
        }),
      ...
      return new[] {
        ...
        new ProfileGroupSection("Sky", ProfileSectionKeys.SkySectionKey, "SkySectionIcon", null, false, new[]
        {
          ...
          ProfileGroupDefinition.ColorGroupDefinition(
            "Ambient Light - Sky Color", ProfilePropertyKeys.AmbientLightSkyColorKey, Color.gray, ProfileFeatureKeys.AmbientLightGradient, true,
            "Adjust the environments ambient light sky color. This affects the environment lighting, not the actual sky color."),
          
          ProfileGroupDefinition.ColorGroupDefinition(
            "Ambient Light - Equator Color", ProfilePropertyKeys.AmbientLightEquatorColorKey, Color.gray, ProfileFeatureKeys.AmbientLightGradient, true,
            "Adjust the environments ambient light equator color. This affects the environment lighting, not the actual sky color."),
          
          ProfileGroupDefinition.ColorGroupDefinition(
            "Ambient Light - Ground Color", ProfilePropertyKeys.AmbientLightGroundColorKey, Color.black, ProfileFeatureKeys.AmbientLightGradient, true,
            "Adjust the environments ambient light ground color. This affects the environment lighting, not the actual sky color."),
        ...
        new ProfileGroupSection("Sun", ProfileSectionKeys.SunSectionKey, "SunSectionIcon", ProfileFeatureKeys.SunFeature, true, new[]
        {
          ...
          ProfileGroupDefinition.NumberGroupDefinition("Sun Transparency", ProfilePropertyKeys.SunAlpha, 0, 1, 1,
            "Transparency of the sun. This property is helpful for animating the sun in and out."),
        ...
        new ProfileGroupSection("Moon", ProfileSectionKeys.MoonSectionKey, "MoonSectionIcon", ProfileFeatureKeys.MoonFeature, true, new[]
        {
          ...
          ProfileGroupDefinition.NumberGroupDefinition("Moon Transparency", ProfilePropertyKeys.MoonAlpha, 0, 1, 1,
            "Transparency of the moon. This property is helpful for animating the moon in and out."),
        ...
        new ProfileGroupSection("Clouds", ProfileSectionKeys.CloudSectionKey, "CloudSectionIcon", ProfileFeatureKeys.CloudFeature, true, new[]
        {
          ...
          ProfileGroupDefinition.NumberGroupDefinition("Cloud Fade-Out Amount", ProfilePropertyKeys.CloudFadeAmountKey, 0, 1, .75f, ProfileFeatureKeys.NoiseCloudFeature, true,
            "This is the amount of fade out that will happen to clouds as they reach the horizon. It creates a smooth fadeout towards the horizon."),
          
          ProfileGroupDefinition.NumberGroupDefinition("Cloud Transparency", ProfilePropertyKeys.CloudAlpha, 0, 1, 1, ProfileFeatureKeys.CloudFeature, true,
            "Overall transparency of the clouds. This is useful for fading clouds in or out, or creating a softer cloud style.")
        }),
