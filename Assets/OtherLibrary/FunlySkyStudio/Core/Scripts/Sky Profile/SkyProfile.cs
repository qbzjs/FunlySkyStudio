...
namespace Funly.SkyStudio
{
  ...
  public class SkyProfile : ScriptableObject
  {
    ...
    // Version of the shader for versions before 2019.1 that uses global keywords.
...
#pragma warning restore
    ...
    public void GetSpherePointPropertyValueNoGc(string propertyKey, float timeOfDay, ref SpherePoint spherePoint)
    {
      SpherePointKeyframeGroup group = GetGroup<SpherePointKeyframeGroup>(propertyKey);
      if (group == null) {
          Debug.LogError("Can't find a sphere point group with property key: " + propertyKey);
      ...
      group.SpherePointForTimeNoGc(timeOfDay, ref spherePoint);
    }
