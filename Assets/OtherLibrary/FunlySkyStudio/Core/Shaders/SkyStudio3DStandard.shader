...
// #endif // CLOUDS
      ...
      fixed4 frag(v2f i) : SV_Target {
        ...
        float2 sunTexUV = ConvertLocalPointToUV(i.sunLocalPosition.xyz, _SunRadius * 2.0f);
          ...
          #if SUN_SPRITE_SHEET
            uint spriteFrameIndex1 = GetSpriteTargetIndex(_SunSpriteItemCount, _SunSpriteAnimationSpeed, 0.0f);
            float2 spriteItemSize1 = GetSpriteItemSize(_SunSpriteDimensions.xy);

            sunTexUV = GetSpriteSheetCoords(sunTexUV, _SunSpriteDimensions, spriteFrameIndex1, spriteItemSize1, _SunSpriteItemCount);
          #endif
