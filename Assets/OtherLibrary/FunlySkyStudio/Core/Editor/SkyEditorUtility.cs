...
namespace Funly.SkyStudio
{
  public abstract class SkyEditorUtility
  {
    ...
    /// <summary>
    ///  Cache the Sky Studio root folder. We used to look this up dynamically but was to slow
    /// for the sky timeline.
    /// </summary>
    public static string _cachedSkyStudioRootDir;
    ...
    public static void ClearSkyStudioRootDirectoryCachedPath()
    {
      _cachedSkyStudioRootDir = null;
    }
    
    // Dynamically lookup the root directory for Sky Studio.
    public static string SkyStudioRootDirectory() {
      if (_cachedSkyStudioRootDir != null)
      {
        return _cachedSkyStudioRootDir;
      }
      ...
      string rootDir = Path.GetDirectoryName(readmeAssetPath);
      if (rootDir == null)
      {
        return null;
      }
      ...
      _cachedSkyStudioRootDir = rootDir;
