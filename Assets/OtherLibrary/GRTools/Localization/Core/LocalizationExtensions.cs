...
namespace GRTools.Localization
{
    public partial class LocalizationManager
    {
        ...
        /// default language
        /// </param>
        public static void Init(LanguageCode systemLanguage, bool followSystem = true, LanguageCode defaultLanguage = LanguageCode.en)
        {
            Init(new LocalizationResourcesLoader(), new LocalizationDefaultParser(), systemLanguage, followSystem, defaultLanguage);
        }
        ...
        /// default language
        /// </param>
        public static void Init(ILocalizationLoader assetLoader, LocalizationTextType textType, LanguageCode systemLanguage, bool followSystem = true, LanguageCode defaultLanguage = LanguageCode.en)
        {
            Init(assetLoader, new LocalizationDefaultParser(textType), systemLanguage, followSystem, defaultLanguage);
        }
