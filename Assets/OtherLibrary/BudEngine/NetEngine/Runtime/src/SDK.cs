...
namespace BudEngine.NetEngine.src {
    ...
    public class Sdk {
        ...
        //    };
        //    Core.User.ChangeCustomPlayerStatus (req, callback);
        //}

        ///// <summary>
        ///// 修改玩家属性
        ///// </summary>
        //public static void ChangeRoomPlayerProfile (ChangeRoomPlayerProfilePara para, Action<ResponseEvent> callback) {
        //    var req = new ChangeRoomPlayerProfileReq {
        //        CustomProfile = para.CustomProfile
        //    };
        //    Core.User.ChangeRoomPlayerProfile (req, callback);
        //}
            ...
            void Connect()
            {
                ...
                {          
                    ...
                    _socket2.OnceEvent("connect", (SocketEvent e) =>
                    {
                       ...
                       _socket2.EventOnceHandlers.Clear();
                        _socket2.SetScocketStatus(SocketTask.Open);
                        StartFrame();
                    });
                    // StartFrame();
        ...
        public static void GetGameInfo(GetGameInfoPara para, Action<ResponseEvent> callback)
        {
            var req = new GetGameInfoReq {
                RoomId = para.RoomId,
                GameType = para.GameType,
                
            };
            Core.BattleGame.GetGameInfo (req, callback);
        }
        
        public static void SendGameData(SendGameDataPara para, Action<ResponseEvent> callback)
        {
            var req = new SendGameDataReq {
                RoomId = para.RoomId,
                ReqType = para.ReqType,
                GameData = para.GameData
            };
            Core.BattleGame.SendGameData (req, callback);
        }
