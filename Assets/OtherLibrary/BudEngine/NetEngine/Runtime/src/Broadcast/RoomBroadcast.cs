...
namespace BudEngine.NetEngine.src.Broadcast {
    public class RoomBroadcast {
        private readonly BudEngine.NetEngine.Room _room;
        public FrameBroadcast FrameBroadcast { get; }
        public int FrameBroadcastFrameId { get; } = 0;

        public RoomBroadcast (BudEngine.NetEngine.Room room) {
            this._room = room;
        ...
        //    var roomInfo = ((ChangeRoomPlayerProfileBst)eve.Data).RoomInfo;
        //    this.Save (eve, roomInfo);
        //    _room.OnChangeRoomPlayerProfile?.Invoke (eve);
        //}
        ...
        public void OnRecvBattleGameBst (BroadcastEvent eve) {
            _room.OnBattleGameBst?.Invoke (eve);
        }
    ...
    public class GlobalRoomBroadcast {
        ...
        //        },
        //        eve.Seq);
        //    BudEngine.NetEngine.Room.OnMatch?.Invoke (roomEvent);
        //}
        ...
        //        },
        //        eve.Seq);
        //    BudEngine.NetEngine.Room.OnCancelMatch?.Invoke (roomEvent);
        //}
    }
}