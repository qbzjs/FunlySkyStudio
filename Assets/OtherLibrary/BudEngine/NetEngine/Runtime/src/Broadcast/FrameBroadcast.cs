...
namespace BudEngine.NetEngine.src.Broadcast
{
    ...
    public class FrameBroadcast
    {
        ...
        public void Push(BroadcastEvent eve, BudEngine.NetEngine.Room room)
        {
        ...
        public void RetryFill(BudEngine.NetEngine.Room room)
        {
        ...
        private void Fill(int beginFrameId, int endFrameId, BudEngine.NetEngine.Room room)
        {
            if (!room.IsInRoom())
            {
                return;
