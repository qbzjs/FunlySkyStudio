...
namespace BudEngine.NetEngine {
    ...
    public class Room : RoomBroadcastHandler {
        ...
        public static void GetMyRoom (GetRoomByRoomIdPara para, Action<ResponseEvent> callback) {
            Sdk.GetRoomByRoomId (para, (eve) => {
                if (eve.Data != null) {
                    var rsp = (GetRoomByRoomIdRsp)eve.Data;
                    eve.Data = rsp;
        ...
        public Action<Room, ResponseEvent> OnUpdate = (room, eve) => {
        ...
        /// <summary>
        /// 简化版进房流程，Create/Match/Join交由服务器处理
        /// </summary>
        /// <param name="enterRoomPara"></param>
        /// <param name="callback"></param>
        public void EnterRoom (EnterRoomPara enterRoomPara, Action<ResponseEvent> callback) {
            Sdk.EnterRoom (enterRoomPara, (eve) => {
                if (eve.Data != null) {
        ...
        /// <param name="para"></param>
        /// <param name="callback"></param>
        public void RoomChat(SendToClientPara para, Action<ResponseEvent> callback)
        {
            Sdk.SendToClient(para, this.RoomInfo.Id, (eve) =>
            {
                if (eve.Data != null)
                {
                    var rsp = (SendToClientRsp)eve.Data;
                    eve.Data = rsp;
                }
                callback?.Invoke(eve);
            });
        ...
        /// <param name="para"></param>
        /// <param name="callback"></param>
        public void LeaveRoom (LeaveRoomPara para, Action<ResponseEvent> callback) {
            Sdk.LeaveRoom (para, (eve) => {
                if (eve.Data != null) {
        ...
        {
            Sdk.Instance.ClientSendToServer(para, RoomInfo.Id, callback);
        }
    }
}