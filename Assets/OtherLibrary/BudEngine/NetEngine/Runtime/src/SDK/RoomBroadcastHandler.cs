...
namespace BudEngine.NetEngine.src.SDK
{
    public abstract class RoomBroadcastHandler {
        ...
        public Action<BroadcastEvent> OnChangeRoomPlayerProfile { get; set; }
        ...
        public Action<BroadcastEvent> OnBattleGameBst { get; set; }
    }
}