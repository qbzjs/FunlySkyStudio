...
namespace agora_gaming_rtc
{
        ...
        */
        ...
        public delegate void OnGMEngineRequestTokenHandler();
        public delegate void OnEnterRoomSuccessHandler();
        public delegate void OnEnterRoomFailHandler();
        public delegate void OnConnectionStateChangeHandler(GME_CONNECTION_STATE_TYPE state, GME_CONNECTION_CHANGED_REASON_TYPE reason);
        public delegate void OnLostSyncHandler(Int64 lostSyncTimeMs);
        public delegate void OnGetSyncHandler(Int64 lostSyncTimeMs);
        public delegate void OnTeamMateChangeHandler(IntPtr uids, int userCount);
}